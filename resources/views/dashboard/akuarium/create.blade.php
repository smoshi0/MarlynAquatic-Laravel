...
@section('container')
    ...
    <h1 class="h2">Tambah Data Akuarium</h1>
  </div>

  <div class="col-lg-8 mb-5">

    <form method="post" action="/dashboard/akuarium" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
              <label for="nama_ikan" class="form-label">Nama Ikan</label>
              <input type="text" class="form-control @error('nama_ikan') is-invalid @enderror" id="nama_ikan" name="nama_ikan" autofocus required value="{{ old('nama_ikan') }}">
              @error('nama_ikan')
        ...
        <div class="mb-3">
              ...
              <input type="text" class="form-control @error('kode_akuarium') is-invalid @enderror" id="kode_akuarium" name="kode_akuarium" required value="{{ old('kode_akuarium') }}">
              @error('kode_akuarium')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>     
        ...
        <div class="mb-3">
              ...
              <input type="number" min="0.00" max="100000.00" step="0.01" class="form-control @error('harga_ikan') is-invalid @enderror" id="harga_ikan" name="harga_ikan" required value="{{ old('harga_ikan') }}">
              @error('harga_ikan')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>     
