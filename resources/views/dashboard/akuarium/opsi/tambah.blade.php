...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Tambah Jumlah {{ $akuarium->nama_ikan }} {{ $akuarium->kode_akuarium }}</h1>
  </div>
  ...
  <div class="col-lg-4 mb-5">
    <form method="post" action="/dashboard/akuarium/{{ $akuarium->slug }}">
        ...
        @csrf
        <div class="mb-3">
            <label for="jumlah_ikan" class="form-label">Jumlah Ikan Sebelum Ditambahkan</label>
            <input type="text" readonly class="form-control value1" value="{{ $akuarium->jumlah_ikan }}">
        </div>
        <div class="mb-3">
            <label for="jumlah_ikan" class="form-label">Masukkan Jumlah Ikan</label>
